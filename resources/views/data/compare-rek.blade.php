   ...
   <script>
    $(document).ready(function() {
        ...
        function updateTotal() {
            ...
            $('#totalOriginal').text(totalOriginal.toLocaleString('id-ID', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
            $('#totalRevisi').text(totalRevisi.toLocaleString('id-ID', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
            $('#totalSelisih').text(totalSelisih.toLocaleString('id-ID', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
        }
    });
</script>
